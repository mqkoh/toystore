...
<div id="product-grid">
	<div class="txt-heading">Dream Realm - Lego</div>
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM product WHERE prodCategory = 'Lego' ORDER BY prodID ASC");
