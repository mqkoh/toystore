...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!empty($_POST['pass1'])){
		...
		$q = "SELECT custID,custName,custGender,custEmail,custPhone,custAdd FROM customer WHERE (custEmail='$e' AND custPW=SHA1('$p') )";
...
<form action="password.php" method="post">
	...
	<p>Name&nbsp;: <input type="text" name="custName" size="20" maxlength="60" value="'.$row[].'"  /></p>
